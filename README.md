...
[![Go Report Card](https://goreportcard.com/badge/github.com/stablyio/go-ethereum-hdwallet?)](https://goreportcard.com/report/github.com/stablyio/go-ethereum-hdwallet)
[![GoDoc](https://godoc.org/github.com/stablyio/go-ethereum-hdwallet?status.svg)](https://godoc.org/github.com/stablyio/go-ethereum-hdwallet)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](#contributing)

## Install

```bash
go get -u github.com/stablyio/go-ethereum-hdwallet
```

## Documenation

[https://godoc.org/github.com/stablyio/go-ethereum-hdwallet](https://godoc.org/github.com/stablyio/go-ethereum-hdwallet)
...
import (
	...
	"github.com/stablyio/go-ethereum-hdwallet"
)
...
```bash
go install github.com/stablyio/go-ethereum-hdwallet/cmd/geth-hdwallet@latest
```
